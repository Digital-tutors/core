...
interface TaskResultsRepository : MongoRepository<TaskResults, String> {
    ...
    fun findAllByUserIdOrderByCreatedDtDesc(userId: User): List<TaskResults>
    ...
    fun findAllByUserIdAndTaskIdOrderByCreatedDtDesc(userId: User, taskId: Task): List<TaskResults>
